...
export const SEMANTIC_KINDS: SemanticKind[] = [
  ...
  { kind: 'evidence', label: 'Evidence', arabic: 'دليل', color: 'blue', icon: '│', aliases: ['evidence', 'dalil', 'proof'] },
  ...
  { kind: 'qaidah', label: 'Qāʿidah', arabic: 'قاعدة', color: 'amber', icon: '⬡', aliases: ['qaidah', 'rule', 'principle'] },
  { kind: 'athar', label: 'Athar', arabic: 'أثر', color: 'blue', icon: '◈', aliases: ['athar', 'narration'] },
  { kind: 'scholar', label: 'Scholar quotation', color: 'amber', icon: '❝', aliases: ['scholar', 'quote', 'shaykh'] },
